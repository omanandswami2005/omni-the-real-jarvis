...
> **Date:** March 10, 2026  
> **Purpose:** Exhaustive inventory of Vertex AI and Google Cloud Platform features applicable to the Omni project.  
> **Goal:** Maximize Google Cloud usage by using 16+ GCP services meaningfully.
...
| **Video Generation (Veo)** | Generate video from text/image prompts | Cool but overkill for MVP | 6+ hrs | SKIP |
| **Model Tuning (LoRA/QLoRA)** | Fine-tune Gemini on your data | Overkill for MVP | 10+ hrs | SKIP |
...
| **Model Garden** | 200+ models (Claude, Llama, Mistral, etc.) | Could show multi-model support but adds complexity | 4+ hrs | SKIP |
...
- **Most projects won't have this** — it's a newer service most people don't know about
...
This depth of Google Cloud usage — spanning Vertex AI GenAI, Agent Engine data services, infrastructure, observability, and DevOps — is comprehensive and hard to match. Most projects use Gemini + ADK + Cloud Run and call it done.
